...
#[cfg(feature = "keyring")]
pub fn set_keyring_password(name: &str, password: &SecretString) -> Result<(), crate::error::ConfigError> {
...
#[cfg(not(feature = "keyring"))]
pub fn set_keyring_password(_name: &str, _password: &SecretString) -> Result<(), crate::error::ConfigError> {
